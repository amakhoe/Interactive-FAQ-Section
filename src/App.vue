...
export default {
  ...
  {
    title: 'How do I access   documentation?',
    description: 'We offers a variety of billing options, including monthly and annual subscription plans, as well as pay-as-you-go pricing for certain services. Payment is typically made through a credit card or other secure online payment method.'
  },
  {
    title: 'Do you offer any discounts or promotions?',
    description: '   We may offer discounts or promotions from time to time. To stay up-to-date on the latest deals and special offers, you can sign up for the companys newsletter or follow it on social media.'
  },
  {
    title: 'How do we compare to other similar services?',
    description: 'This platform is a highly reliable and feature-rich service that offers a wide range of tools and functionality. It is competitively priced and offers a variety of billing options to suit different needs and budgets.'
  },
...
<template>
    ...
    >
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative text-center">
        ...
        >
          comece a crescer com o projecto 
          <span class="text-indigo-600">Onit </span>
        </h1>
        <p
          class="max-w-sm mx-auto text-center text-base font-normal leading-7 text-gray-500 mb-9"
        >
          Invista teu tempo da forma mais inteligente com os melhores recursos e mais desafios
        </p>
        <a
          href="javascript:;"
  ...
  <section class="max-w-screen-xl mx-auto px-5 bg-white min-h-sceen">
	...
	<div class="grid divide-y divide-neutral-200 max-w-xl mx-auto mt-8">
		<div class="py-5" v-for="type in msg" :key="type">
			<details class="group">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
                ...
                <div class="lg:mx-auto text-left ">
                    <h4 class="text-lg text-gray-900 font-medium mb-7">Onit</h4>
            ...
            <div class="py-7 border-t border-gray-200">
                <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                    <span class="text-sm text-gray-500 ">©<a href="https://pagedone.io/">Onit</a> 2024, All rights reserved.</span>
